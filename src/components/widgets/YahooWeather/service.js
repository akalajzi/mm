...
YahooWeather.prototype.getMockWeather = function() {
...
*/
var getWeather = function (location, unit) {
  ...
  // var locationUrl = 'https://query.yahooapis.com/v1/public/yql?q=select * from geo.places where text="colorado springs, co"&format=json';
    ...
    const locationQuery = escape("select * from weather.forecast where woeid in (select woeid from geo.places(1) where text='" + location + "') and u='" + unit + "'");
    const locationUrl = "https://query.yahooapis.com/v1/public/yql?q=" + locationQuery + "&format=json&env=store://datatables.org/alltableswithkeys";
    // const locationUrl = 'https://query.yahooapis.com/v1/public/yql?q=select * from weather.forecast where woeid in (select woeid from geo.places(1) where text="'+location+'")&format=json&env=store://datatables.org/alltableswithkeys';
